...
% 3 November 2021
% 
% For each stroke-station pair in APfile, finds associated sferics in
% Sfiles.
% 
% INPUTS:
%       APfile(s)
...
starttime = datenum(2021,07,08,00,00,00);
stoptime = datenum(2021,07,09,00,00,00);
...
for stID = 11 %1:122
    ...
    lidx = sub2ind(size(flrAPpower),row + 1,col); %indices of strokes detected by stID in bigAPpower
