...
save('d_gridcross_10m_20170906.mat','d_gridcross');
save('mm_gridcross_10m_20170906.mat','mm_gridcross');

save('20170906_attencont_lat.mat','latc');
save('20170906_attencont_lon.mat','lonc');
save('20170906_attencont_maxrad.mat','maxrad');

save('gc_var_10m_20170906.mat','gc_variance');
save('gc_kurt_10m_20170906.mat','gc_kurtosis');
save('gc_skew_10m_20170906.mat','gc_skewness');
save('gc_maz_10m_20170906.mat','gc_meanaz');
